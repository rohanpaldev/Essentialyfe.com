      ...
      <?php require('./header.php'); ?>
           ...
           <section class="breadcrumbs-custom-inset">
            <div class="breadcrumbs-custom context-dark bg-overlay-60">
              ...
              <div class="box-position" style="background-image: url(images/8gYh3K6o.jpeg);"></div>
            </div>
          </section>
         ...
         <!-- Card Deck -->
            <div class="card-deck-container">
              <div class="card-deck">
                      ...
                      <?php
       $query = "SELECT * FROM properties WHERE ltfr='on'";
         ...
         <div class='card mb-4' style='margin-top:20px;'>
          <form method='post' action='property.php'><a href='contact.php'>
                    ...
                    <div class='card-body'>
                      ...
                      <p style='float:right; margin-bottom:5px; margin-top:-22px; font-size:12.5px;'><b>Starting at $res[price] Per Month</b></p>
                      </div>
                      <input type='text' name='real_id' value='$res[id]' style='display:none;'>
                      
                  </div><input value='Starting at $res[price] Per Month' type='submit' class='btn btn-purple' style='display:none; width:100%; font-size:12px;'></form>
                  </div></a></div>";
}
    ?>
