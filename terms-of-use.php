...
<html class="wide wow-animation" lang="en">
  <head>
    <title>Terms Of Use | EssentiaLyfe</title>
      ...
      <section class="section section-sm section-first bg-default text-md-left">
        <div class="container">
          <div class="row row-50 justify-content-center align-items-xl-center">
            <div class="col-md-10 col-lg-10 col-xl-20" style="width:100%;">
              <h1 class="text-spacing-25 font-weight-normal title-opacity-9"style="color:#322d31; font-size:35px; margin-left:15px;">Terms Of Use</h1>
              <!-- Bootstrap tabs-->
...
<p>The EssentiaLyfe.com website located at www.essentialyfe.com is a copyrighted work belonging to EssentiaLyfe, Inc.. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
...
<p><strong>Third-Party Links & Ads; Other Users</strong></p>
...
<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: 7969 Melrose Ave, West Hollywood, CA. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
...
<p>Address: 7969 Melrose Ave, West Hollywood, CA</p>
<p>Email: info@essentialyfe.com</p>
</div>
</div>
